		...
		<div className="container">
			...
			{user ? (
				<div className="card p-5 mt-5" style={{ backgroundColor: "whitesmoke" }}>
					<h4 className="card-title text-center">informations de l'utilisateur</h4>
								...
								<div className="row g-0">
									...
									<div className="col-md-10">
										<div className="card-body">
											...
											<div className="form-group row">
												<label className="col-md-2 col-form-label fw-bold">Prénom:</label>
												<div className="col-md-10">
											...
											<div className="form-group row">
												<label className="col-md-2 col-form-label fw-bold">Nom:</label>
												<div className="col-md-10">
